...
public class ExcelUtils {
    ...
    public List<String> getColumnsNames() {   //headers of excelsheet
    ...
    public void setCellData(String value, int rowNum, int colNum) {  //data type eder
        Cell cell;
        Row row;
        try {
    ...
    public void setCellData(String value, String columnName, int row) {   //üstteki metotla birlikte çalışır, overload eder, parametreleri farklıdır.
    ...
    //Exceldeki dataları başlıksız olarak 2 boyutlu array şeklinde return eder.
